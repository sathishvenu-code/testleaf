...
test(`Test to Verify Lead Creation and Conversion to Opportunity`, async ({page}) => {
    ...
    //login happens from saved cookies here we are directly landing to home page.    
    await page.goto("https://testcompany354-dev-ed.develop.lightning.force.com/lightning/setup/SetupOneHome/home");   
